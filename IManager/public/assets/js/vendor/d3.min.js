...
!(function (t, n) {
    ...
    on: function (t, n) {
      ...
      if (!(arguments.length < 2)) {
        ...
        for (; ++o < a; )
          ...
          else if (null == n) for (e in r) r[e] = G(r[e], t.name, null);
        return this;
      }
      for (; ++o < a; )
        ...
        : function (t) {
            return function () {
              var n = this.ownerDocument,
                e = this.namespaceURI;
              return e === V && n.documentElement.namespaceURI === V
                ? n.createElement(t)
  ...
  function St(t, n, e) {
    var r = Mt.hasOwnProperty(t.type) ? Nt : At;
  ...
  Pt.prototype = zt.prototype = {
    ...
    on: function (t, n, e) {
      var r,
        ...
        a = o.length;
      if (!(arguments.length < 2)) {
        for (u = n ? St : Tt, null == e && (e = !1), r = 0; r < a; ++r)
          this.each(u(o[r], n, e));
        return this;
      }
  ...
  function vn(t) {
    ...
    return (
      ...
      (n = rn.exec(t))
        ...
        ? gn(parseInt(n[1], 16))
        : (n = an.exec(t))
        ? new mn(n[1], n[2], n[3], 1)
        : (n = un.exec(t))
        ? new mn((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, 1)
        : (n = cn.exec(t))
        ? yn(n[1], n[2], n[3], n[4])
        : (n = fn.exec(t))
        ? yn((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
        : (n = sn.exec(t))
      ...
      Kt(Jt, {
        ...
        rgb: function () {
          var t = (this.h % 360) + 360 * (this.h < 0),
            ...
            i = 2 * e - r;
          return new mn(
            kn(t >= 240 ? t - 240 : t + 120, i, r),
            kn(t, i, r),
            kn(t < 120 ? t + 240 : t - 120, i, r),
            this.opacity
          );
        },
        displayable: function () {
  ...
  function On(t) {
    ...
    var n,
      ...
      i = jn(t.g),
      o = jn(t.b),
      a = Fn((0.2225045 * r + 0.7168786 * i + 0.0606169 * o) / zn);
    return (
      r === i && i === o
        ? (n = e = a)
        : ((n = Fn((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Pn)),
          (e = Fn((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / Rn))),
  ...
  function Xn(t) {
    ...
    if ((t instanceof Yn || (t = On(t)), 0 === t.a && 0 === t.b))
    ...
    Kt(Jt, {
      ...
      rgb: function () {
        ...
        return new mn(
          ...
          Hn(-0.9787684 * n + 1.9161415 * t + 0.033454 * e),
          Hn(0.0719453 * n - 0.2289914 * t + 1.4052427 * e),
          this.opacity
        );
      },
    })
  ...
  function pe(t) {
    return function (n) {
      var e,
        ...
        u = new Array(i);
      for (e = 0; e < i; ++e)
        (r = bn(n[e])), (o[e] = r.r || 0), (a[e] = r.g || 0), (u[e] = r.b || 0);
      return (
        (o = t(o)),
        (a = t(a)),
        (u = t(u)),
  ...
  function Me(t, n) {
    var e,
      r,
      i,
      o = (xe.lastIndex = we.lastIndex = 0),
      a = -1,
      u = [],
      c = [];
    for (t += "", n += ""; (e = xe.exec(t)) && (r = we.exec(n)); )
      (i = r.index) > o &&
      ...
      function (t) {
        return "none" === t
          ...
          : (Te ||
            ...
            (Te.style.transform = t),
            (t = ke
              .getComputedStyle(Se.appendChild(Te), null)
        ...
        return null == t
          ...
          : (Ee ||
            ...
            (t = Ee.transform.baseVal.consolidate())
              ? ze((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f)
              : Pe);
      },
      ", ",
      ")",
  ...
  function hr() {
    cr(), ++Je;
    for (var t, n = Qe; n; )
      (t = ir - n._time) >= 0 && n._call.call(null, t), (n = n._next);
    --Je;
  }
  function dr() {
  ...
  function vr(t) {
    Je ||
      ...
      t - ir > 24
        ? (t < 1 / 0 && (tr = setTimeout(dr, t - ar.now() - or)),
          nr && (nr = clearInterval(nr)))
        : (nr || ((rr = ar.now()), (nr = setInterval(pr, er))),
          (Je = 1),
          ur(dr)));
  }
  function gr(t, n, e) {
  ...
  sr.prototype = lr.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? cr() : +e) + (null == n ? 0 : +n)),
        this._next ||
          Ke === this ||
          (Ke ? (Ke._next = this) : (Qe = this), (Ke = this)),
        (this._call = t),
        (this._time = e),
        vr();
    },
    ...
    !(function (t, n, e) {
      ...
      function o(c) {
        ...
        if (
          (gr(function () {
            e.state === wr &&
              ((e.state = Mr), e.timer.restart(a, e.delay, e.time), a(c));
          }),
          (e.state = xr),
          ...
          for (
            e.state = wr, r = new Array((l = e.tween.length)), f = 0, s = -1;
            f < l;
            ++f
          )
        ...
        for (
          var i =
              n < e.duration
                ...
                : (e.timer.restart(u), (e.state = Nr), 1),
            o = -1,
            a = r.length;
          ++o < a;
  ...
  Lr.prototype = Ur.prototype = {
    ...
    tween: function (t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = Er(this.node(), e).tween, o = 0, a = i.length;
          o < a;
          ++o
        )
  ...
  var ui = (function t(n) {
    ...
    pi = { time: null, delay: 0, duration: 250, ease: Fr };
  function vi(t, n) {
  ...
  (zt.prototype.interrupt = function (t) {
    ...
    (zt.prototype.transition = function (t) {
      ...
      t instanceof Lr
        ? ((n = t._id), (t = t._name))
        : ((n = Or()), ((e = pi).time = cr()), (t = null == t ? null : t + ""));
      for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
        for (var a, u = r[o], c = u.length, f = 0; f < c; ++f)
          (a = u[f]) && Tr(a, t, n, f, u, e || vi(a, n));
  ...
  var Si = {
    ...
    Pi = { e: "w", w: "e", nw: "ne", ne: "nw", se: "sw", sw: "se" },
    zi = { n: "s", s: "n", nw: "sw", ne: "se", se: "ne", sw: "nw" },
    Ri = {
      overlay: 1,
      selection: 1,
      n: null,
  ...
  function Yi(n) {
    ...
    function d() {
      if ((!e || t.event.touches) && i.apply(this, arguments)) {
        ...
        "overlay" === m
          ...
          : ((r = T[0][0]), (u = T[0][1]), (f = T[1][0]), (d = T[1][1])),
          (o = r),
          (c = u),
          (h = f),
          (p = d);
        ...
        if (t.event.touches) (U.moved = F), (U.ended = H);
          ...
          var Y = Rt(t.event.view)
            .on("mousemove.brush", F, !0)
      ...
      function I() {
        ...
        h < o &&
          ...
          g && ((o = T[0][0]), (h = T[1][0])),
          y && ((c = T[0][1]), (p = T[1][1])),
          (T[0][0] === o && T[0][1] === c && T[1][0] === h && T[1][1] === p) ||
            ((N.selection = [
              [o, c],
              [h, p],
            ]),
    ...
    return (
      ...
      (h.prototype = {
        ...
        emit: function (t) {
          kt(new _i(f, t, n.output(this.state.selection)), u.apply, u, [
            t,
            this.that,
            this.args,
          ]);
      ...
      (f.extent = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : yi(Ti(t))), f)
          : r;
      }),
      (f.filter = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : yi(!!t)), f)
          : i;
      }),
    ...
    function o(e, i) {
      ...
      return (
        (function (e, r, i) {
          ...
          for (; ++o < t - 1; )
            (c = f), (f = e[o + 1] >= r), Mo[c | (f << 1)].forEach(p);
          Mo[f << 0].forEach(p);
          for (; ++u < n - 1; ) {
            for (
              o = -1,
    ...
    function r(t, n) {
      ...
      function s() {
        ...
        if (t.charCodeAt(i) === zo) {
          for (
            ;
            (a++ < o && t.charCodeAt(a) !== zo) || t.charCodeAt(++a) === zo;
      ...
      for (
        t.charCodeAt(o - 1) === Ro && --o, t.charCodeAt(o - 1) === Do && --o;
        (r = s()) !== Po;
  ...
  (ba.copy = function () {
    var t,
      n,
      e = new ya(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
      r = this._root;
    if (!r) return e;
    ...
    (ba.visit = function (t) {
      var n,
        ...
        c = this._root;
      for (
        c && u.push(new da(c, this._x0, this._y0, this._x1, this._y1));
        (n = u.pop());
    ...
    (ba.visitAfter = function (t) {
      ...
      for (
        this._root &&
        e.push(new da(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
  ...
  var qa = {
    ...
    s: function (t, n) {
      ...
      return o === a
        ...
        : "0." + new Array(1 - o).join("0") + ka(t, Math.max(0, n + o - 1))[0];
    },
    X: function (t) {
      ...
      function M(t) {
        ...
        switch (
          ...
          case "=":
            ...
            break;
          case "^":
            t = T.slice(0, (A = T.length >> 1)) + h + t + M + T.slice(A);
            break;
          default:
            t = T + h + t + M;
        }
  ...
  function Ha(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(Ea(n) / 3))) - Ea(Math.abs(t))
    );
  }
  function ja(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Ea(n) - Ea(t)) + 1
    );
  }
  function Xa() {
    return new Ga();
  ...
  Fa({
    ...
    (Ga.prototype = {
      ...
      add: function (t) {
        $a(Va, t, this.t),
          $a(this, Va.s, this.s),
          this.s ? (this.t += Va.t) : (this.s = Va.t);
      },
      valueOf: function () {
        return this.s;
      },
  ...
  function gu(t) {
    return t > 1 ? Ka : t < -1 ? -Ka : Math.asin(t);
  }
  function yu(t) {
    return (t = lu(t / 2)) * t;
  }
  function _u() {}
  function bu(t, n) {
    t && xu.hasOwnProperty(t.type) && xu[t.type](t, n);
  }
  var mu = {
    ...
    xu = {
      ...
      GeometryCollection: function (t, n) {
        for (var e = t.geometries, r = -1, i = e.length; ++r < i; ) bu(e[r], n);
      },
    };
  function wu(t, n, e) {
    var r,
  ...
  function Mu(t, n) {
    var e = -1,
      r = t.length;
    for (n.polygonStart(); ++e < r; ) wu(t[e], n, 1);
    n.polygonEnd();
  }
  function Nu(t, n) {
    t && mu.hasOwnProperty(t.type) ? mu[t.type](t, n) : bu(t, n);
  }
  var Au,
    Tu,
    Su,
    ...
    zu = {
      ...
      polygonStart: function () {
        Cu.reset(), (zu.lineStart = Ru), (zu.lineEnd = Du);
      },
      polygonEnd: function () {
        var t = +Cu;
        Pu.add(t < 0 ? tu + t : t),
          (this.lineStart = this.lineEnd = this.point = _u);
      },
      sphere: function () {
        Pu.add(tu);
      },
  ...
  function Lu(t, n) {
    var e = (t *= eu) - Su,
      ...
      c = ku * o + u * au(i),
      f = u * r * lu(i);
    Cu.add(ou(f, c)), (Su = t), (ku = o), (Eu = a);
  }
  function Uu(t) {
    return [ou(t[1], t[0]), gu(t[2])];
  }
  function Ou(t) {
    var n = t[0],
      e = t[1],
      r = au(e);
    return [r * au(n), r * lu(n), lu(e)];
  }
  function Bu(t, n) {
  ...
  function Hu(t) {
    var n = du(t[0] * t[0] + t[1] * t[1] + t[2] * t[2]);
    (t[0] /= n), (t[1] /= n), (t[2] /= n);
  }
  var ju,
    Xu,
  ...
  function bc(t, n) {
    ...
    if (Qu) {
      ...
      f ^ (u * $u < c && c < u * t)
        ? (o = i[1] * nu) > Vu && (Vu = o)
        : f ^ (u * $u < (c = ((c + 360) % 360) - 180) && c < u * t)
        ? (o = -i[1] * nu) < Xu && (Xu = o)
        : (n < Xu && (Xu = n), n > Vu && (Vu = n)),
        f
          ? t < $u
            ? Ac(ju, t) > Ac(ju, Gu) && (Gu = t)
            : Ac(t, Gu) > Ac(ju, Gu) && (ju = t)
          : Gu >= ju
          ? (t < ju && (ju = t), t > Gu && (Gu = t))
          : t > $u
          ? Ac(ju, t) > Ac(ju, Gu) && (Gu = t)
          : Ac(t, Gu) > Ac(ju, Gu) && (ju = t);
    } else Ku.push((Ju = [(ju = t), (Gu = t)]));
    n < Xu && (Xu = n), n > Vu && (Vu = n), (Qu = e), ($u = t);
  }
  function mc() {
    yc.point = bc;
  }
  function xc() {
    (Ju[0] = ju), (Ju[1] = Gu), (yc.point = _c), (Qu = null);
  }
  function wc(t, n) {
    if (Qu) {
      var e = t - $u;
      gc.add(ru(e) > 180 ? e + (e > 0 ? 360 : -360) : e);
    } else (Wu = t), (Zu = n);
    zu.point(t, n), bc(t, n);
  }
  function Mc() {
  ...
  var kc = {
    ...
    lineEnd: Dc,
    polygonStart: function () {
      (kc.lineStart = qc), (kc.lineEnd = Lc);
    },
    polygonEnd: function () {
      (kc.lineStart = Pc), (kc.lineEnd = Dc);
    },
  };
  function Ec(t, n) {
    t *= eu;
    var e = au((n *= eu));
    Cc(e * au(t), e * lu(t), lu(n));
  }
  function Cc(t, n, e) {
    (ec += (t - ec) / ++tc), (rc += (n - rc) / tc), (ic += (e - ic) / tc);
  }
  function Pc() {
    kc.point = zc;
  }
  ...
  function Lc() {
    Oc(lc, hc), (kc.point = Ec);
  }
  function Uc(t, n) {
    (lc = t), (hc = n), (t *= eu), (n *= eu), (kc.point = Oc);
    var e = au(n);
    (dc = e * au(t)), (pc = e * lu(t)), (vc = lu(n)), Cc(dc, pc, vc);
  }
  function Oc(t, n) {
    t *= eu;
    var e = au((n *= eu)),
  ...
  function Fc(t, n) {
    return [ru(t) > Qa ? t + Math.round(-t / tu) * tu : t, n];
  }
  function Ic(t, n, e) {
    return (t %= tu)
      ? n || e
  ...
  function Hc(t) {
    return function (n, e) {
      return [(n += t) > Qa ? n - tu : n < -Qa ? n + tu : n, e];
    };
  }
  function jc(t) {
    var n = Hc(t);
  ...
  function Xc(t, n) {
    ...
    function a(t, n) {
      var a = au(n),
        ...
        f = lu(n),
        s = f * e + u * r;
      return [ou(c * i - s * o, u * e - f * r), gu(s * i + c * o)];
    }
    return (
      (a.invert = function (t, n) {
        var a = au(n),
          ...
          f = lu(n),
          s = f * i - c * o;
        return [ou(c * i + f * o, u * e + s * r), gu(s * e - u * r)];
      }),
      a
    );
  }
  function Gc(t) {
    function n(n) {
      return ((n = t(n[0] * eu, n[1] * eu))[0] *= nu), (n[1] *= nu), n;
    }
    return (
      (t = Ic(t[0] * eu, t[1] * eu, t.length > 2 ? t[2] * eu : 0)),
      (n.invert = function (n) {
        return ((n = t.invert(n[0] * eu, n[1] * eu))[0] *= nu), (n[1] *= nu), n;
      }),
      n
    );
  }
  function Vc(t, n, e, r, i, o) {
    if (e) {
      ...
      for (var f, s = i; r > 0 ? s > o : s < o; s -= c)
        (f = Uu([a, -u * au(s), -u * lu(s)])), t.point(f[0], f[1]);
    }
  }
  function $c(t, n) {
    ((n = Ou(n))[0] -= t), Hu(n);
    var e = vu(-n[1]);
    return ((-n[2] < 0 ? -e : e) + tu - Wa) % tu;
  }
  function Wc() {
    var t,
      n = [];
  ...
  function Zc(t, n) {
    return ru(t[0] - n[0]) < Wa && ru(t[1] - n[1]) < Wa;
  }
  function Qc(t, n, e, r) {
    (this.x = t),
      (this.z = n),
      ...
      (t.forEach(function (t) {
        if (!((n = t.length - 1) <= 0)) {
          ...
          if (Zc(r, a)) {
            ...
            u.push((e = new Qc(r, t, null, !0))),
              c.push((e.o = new Qc(r, null, e, !1))),
              u.push((e = new Qc(a, t, null, !1))),
              c.push((e.o = new Qc(a, null, e, !0)));
        }
      }),
      u.length)
    ) {
  ...
  var tf = Xa();
  function nf(t) {
    return ru(t[0]) <= Qa ? t[0] : hu(t[0]) * (((ru(t[0]) + Qa) % tu) - Qa);
  }
  function ef(t, n) {
    var e = nf(n),
      r = n[1],
      ...
      a = 0,
      u = 0;
    tf.reset(), 1 === i ? (r = Ka + Wa) : -1 === i && (r = -Ka - Wa);
      ...
      if ((l = (s = t[c]).length))
        for (
          ...
          if (
            ...
            var E = Yu(o, k);
            Hu(E);
            var C = (T ^ (M >= 0) ? -1 : 1) * gu(E[2]);
            (r > C || (r === C && (k[0] || k[1]))) &&
              (u += T ^ (M >= 0) ? 1 : -1);
          }
        }
    return (a < -Wa || (a < Wa && tf < -Wa)) ^ (1 & u);
  }
  function rf(t, n, e, r) {
    return function (i) {
      var o,
        ...
        h = {
          ...
          polygonEnd: function () {
            ...
            var t = ef(o, r);
            a.length
              ? (l || (i.polygonStart(), (l = !0)), Kc(a, af, t, e, i))
              : t &&
  ...
  function af(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - Ka - Wa : Ka - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - Ka - Wa : Ka - n[1])
    );
  }
  var uf = rf(
    function () {
    ...
    function a(t, e, r) {
      ...
      if (!(g < 0)) {
        ...
        if (
          ...
          A || N < Wa
            ? A
              ? (w + M > 0) ^ (_[1] < (ru(_[0] - m) < Wa ? w : M))
              : w <= _[1] && _[1] <= M
            : (N > Qa) ^ (m <= _[0] && _[0] <= x))
        ) {
          var T = Iu(d, (-p + y) / v);
          return Fu(T, h), [_, Uu(T)];
        }
      }
    }
    function u(n, e) {
        ...
        return {
          ...
          point: function (l, h) {
            ...
            if (
              (!n && (f = c = v) && t.lineStart(),
              v !== c &&
                (!(d = a(n, p)) || Zc(n, d) || Zc(p, d)) &&
                ((p[0] += Wa), (p[1] += Wa), (v = o(p[0], p[1]))),
              v !== c)
            )
              (s = 0),
                v
    ...
    return function (a) {
      ...
      function M(o, a) {
        ...
        if ((f && s.push([o, a]), y))
          ...
          var c = [
              (p = Math.max(sf, Math.min(ff, p))),
              (v = Math.max(sf, Math.min(ff, v))),
            ],
            m = [
              (o = Math.max(sf, Math.min(ff, o))),
              (a = Math.max(sf, Math.min(ff, a))),
            ];
  ...
  function yf() {
    gf.point = gf.lineEnd = _u;
  }
  function _f(t, n) {
    (hf = t *= eu), (df = lu((n *= eu))), (pf = au(n)), (gf.point = bf);
  }
  function bf(t, n) {
    t *= eu;
    var e = lu((n *= eu)),
      ...
      u = pf * e - df * r * o,
      c = df * e + pf * r * o;
    vf.add(ou(du(a * a + u * u), c)), (hf = t), (df = e), (pf = r);
  }
  function mf(t) {
    return vf.reset(), Nu(t, gf), +vf;
  }
  var xf = [null, null],
    wf = { type: "LineString", coordinates: xf };
  function Mf(t, n) {
    return (xf[0] = t), (xf[1] = n), mf(wf);
  }
  var Nf = {
      Feature: function (t, n) {
    ...
    Af = {
      ...
      Polygon: function (t, n) {
        return Ef(t.coordinates, n);
      },
      MultiPolygon: function (t, n) {
        for (var e = t.coordinates, r = -1, i = e.length; ++r < i; )
          if (Ef(e[r], n)) return !0;
        return !1;
      },
      GeometryCollection: function (t, n) {
  ...
  function Tf(t, n) {
    return !(!t || !Af.hasOwnProperty(t.type)) && Af[t.type](t, n);
  }
  function Sf(t, n) {
    return 0 === Mf(t, n);
  }
  function kf(t, n) {
    for (var e, r, i, o = 0, a = t.length; o < a; o++) {
      if (0 === (r = Mf(t[o], n))) return !0;
      if (
        o > 0 &&
        (i = Mf(t[o], t[o - 1])) > 0 &&
        e <= i &&
        r <= i &&
        (e + r - i) * (1 - Math.pow((e - r) / i, 2)) < Za * i
      )
        return !0;
      e = r;
    }
  ...
  function Ef(t, n) {
    return !!ef(t.map(Cf), Pf(n));
  }
  function Cf(t) {
    return (t = t.map(Pf)).pop(), t;
  }
  function Pf(t) {
    return [t[0] * eu, t[1] * eu];
  }
  function zf(t, n, e) {
    var r = g(t, n - Wa, e).concat(n);
    return function (t) {
  ...
  function Df() {
    ...
    function b() {
      return g(uu(r / p) * p, e, p)
        .map(s)
        .concat(g(uu(u / v) * v, a, v).map(l))
        .concat(
          g(uu(n / h) * h, t, h)
            .filter(function (t) {
              return ru(t % p) > Wa;
  ...
  var Lf,
    ...
    If = {
      ...
      lineEnd: _u,
      polygonStart: function () {
        (If.lineStart = Hf), (If.lineEnd = Gf);
      },
      polygonEnd: function () {
        (If.lineStart = If.lineEnd = If.point = _u), Yf.add(ru(Ff)), Ff.reset();
      },
      result: function () {
        var t = Yf / 2;
        return Yf.reset(), t;
  ...
  function jf(t, n) {
    (If.point = Xf), (Lf = Of = t), (Uf = Bf = n);
  }
  function Xf(t, n) {
    Ff.add(Bf * t - Of * n), (Of = t), (Bf = n);
  }
  function Gf() {
    Xf(Lf, Uf);
  }
  ...
  var Kf,
    ...
    ls = {
      ...
      lineEnd: gs,
      polygonStart: function () {
        (ls.lineStart = ys), (ls.lineEnd = _s);
      },
      polygonEnd: function () {
        (ls.point = hs), (ls.lineStart = ds), (ls.lineEnd = gs);
      },
      result: function () {
        var t = ss
          ? [cs / ss, fs / ss]
          ...
          ? [es / is, rs / is]
          : [NaN, NaN];
        return (es = rs = is = os = as = us = cs = fs = ss = 0), t;
      },
    };
  function hs(t, n) {
    (es += t), (rs += n), ++is;
  ...
  function bs(t, n) {
    (ls.point = ms), hs((Kf = ts = t), (Jf = ns = n));
  }
  function ms(t, n) {
    var e = t - ts,
      r = n - ns,
      ...
      switch (this._point) {
        ...
        default:
          this._context.moveTo(t + this._radius, n),
            this._context.arc(t, n, this._radius, 0, tu);
      }
    },
    result: _u,
  };
  ...
  function Es(t, n) {
    (ks.point = Cs), (Ms = As = t), (Ns = Ts = n);
  }
  function Cs(t, n) {
    (As -= t), (Ts -= n), Ss.add(du(As * As + Ts * Ts)), (As = t), (Ts = n);
  }
  function Ps() {
    this._string = [];
  }
    ...
    point: function (t, n) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        default:
          null == this._circle && (this._circle = zs(this._radius)),
          ...
          function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
            ...
            if (b > 4 * n && v--) {
              var m = a + h,
                ...
                N = gu((w /= M)),
                A =
                  ru(ru(w) - 1) < Wa || ru(o - l) < Wa ? (o + l) / 2 : ou(x, m),
                T = t(A, N),
                S = T[0],
                k = T[1],
                E = S - r,
                ...
                P = _ * E - y * C;
              ((P * P) / b > n ||
                ru((y * E + _ * C) / b - 0.5) > 0.3 ||
                a * h + u * d + c * p < Fs) &&
                (e(r, i, o, a, u, c, S, k, A, (m /= M), (x /= M), w, v, g),
                g.point(S, k),
                e(S, k, A, m, x, w, f, s, l, h, d, p, v, g));
            }
          }
          return function (n) {
            var r,
            ...
            function w() {
              e(s, l, f, h, d, p, i, o, r, a, u, c, Ys, n),
                (v.lineEnd = b),
                b();
            }
            return v;
  ...
  function Gs(t) {
    var n,
      ...
      N = 0.5;
    function A(t) {
      return c(t[0] * eu, t[1] * eu);
    }
    function T(t) {
      return (t = c.invert(t[0], t[1])) && [t[0] * nu, t[1] * nu];
    }
    function S() {
      var t = js(l, 0, 0, b).apply(null, n(p, v)),
        r = (
          b
            ? js
            : function (t, n, e) {
      ...
      return (
        (e = Ic(g, y, _)), (u = Yc(n, r)), (c = Yc(e, u)), (a = Is(u, N)), k()
      );
    }
    function k() {
      return (f = s = null), A;
    ...
    return (
      ...
      (A.rotate = function (t) {
        return arguments.length
          ? ((g = (t[0] % 360) * eu),
            (y = (t[1] % 360) * eu),
            (_ = t.length > 2 ? (t[2] % 360) * eu : 0),
            S())
          : [g * nu, y * nu, _ * nu];
      }),
      (A.angle = function (t) {
        return arguments.length ? ((b = (t % 360) * eu), S()) : b * nu;
      }),
      (A.precision = function (t) {
        return arguments.length ? ((a = Is(u, (N = t * t))), k()) : du(N);
      }),
  ...
  function $s(t, n) {
    ...
    var i = 1 + e * (2 * r - e),
      o = du(i) / r;
    function a(t, n) {
      var e = du(i - 2 * r * lu(n)) / r;
      return [e * lu((t *= r)), o - e * au(t)];
    }
    return (
      (a.invert = function (t, n) {
        var e = o - n;
  ...
  function Ws() {
    return Vs($s).scale(155.424).center([0, 33.6442]);
  }
  function Zs() {
    return Ws()
      .parallels([29.5, 45.5])
  ...
  function Ks(t) {
    return function (n, e) {
      var r = du(n * n + e * e),
        ...
        o = lu(i),
        a = au(i);
      return [ou(n * o, r * a), gu(r && (e * o) / r)];
    };
  }
  var Js = Qs(function (t) {
    return du(2 / (1 + t));
  });
  Js.invert = Ks(function (t) {
    return 2 * gu(t / 2);
  });
  var tl = Qs(function (t) {
    return (t = vu(t)) && t / lu(t);
  });
  function nl(t, n) {
    return [t, fu(pu((Ka + n) / 2))];
  }
  function el(t) {
    var n,
      e,
  ...
  function il(t, n) {
    var e = au(t),
      r = t === n ? lu(t) : fu(e / au(n)) / fu(rl(n) / rl(t)),
      i = (e * su(rl(t), r)) / r;
    if (!r) return nl;
    function o(t, n) {
      i > 0 ? n < -Ka + Wa && (n = -Ka + Wa) : n > Ka - Wa && (n = Ka - Wa);
      var e = i / su(rl(n), r);
      return [e * lu(r * t), i - e * au(r * t)];
    }
    return (
      (o.invert = function (t, n) {
        var e = i - n,
          o = hu(r) * du(t * t + e * e);
        return [(ou(t, ru(e)) / r) * hu(e), 2 * iu(su(i / o, 1 / r)) - Ka];
      }),
      o
    );
  }
  ...
  function al(t, n) {
    var e = au(t),
      r = t === n ? lu(t) : (e - au(n)) / (n - t),
      i = e / r + t;
    if (ru(r) < Wa) return ol;
    function o(t, n) {
      var e = i - n,
        o = r * t;
      return [e * lu(o), i - e * au(o)];
    }
    return (
      (o.invert = function (t, n) {
        var e = i - n;
        return [(ou(t, ru(e)) / r) * hu(e), i - hu(r) * du(t * t + e * e)];
      }),
      o
    );
  }
  (tl.invert = Ks(function (t) {
    return t;
  })),
    (nl.invert = function (t, n) {
      return [t, 2 * iu(cu(n)) - Ka];
    }),
    (ol.invert = ol);
  var ul = 1.340264,
    cl = -0.081106,
  ...
  function hl(t, n) {
    var e = gu(ll * lu(n)),
      ...
      i = r * r * r;
    return [
      (t * au(e)) / (ll * (ul + 3 * cl * r + i * (7 * fl + 9 * sl * r))),
      e * (ul + cl * r + i * (fl + sl * r)),
    ];
  }
  function dl(t, n) {
  ...
  (hl.invert = function (t, n) {
    for (
      ...
      ((o =
        (i =
          (r -= e =
            (r * (ul + cl * i + o * (fl + sl * i)) - n) /
            (ul + 3 * cl * i + o * (7 * fl + 9 * sl * i))) * r) *
        i *
        i),
      !(ru(e) < Za));
      ++a
    ...
    return [
      (ll * t * (ul + 3 * cl * i + o * (7 * fl + 9 * sl * i))) / au(r),
      gu(lu(r) / ll),
    ];
  }),
    (dl.invert = Ks(iu)),
    (vl.invert = function (t, n) {
      var e,
        r = n,
        i = 25;
      do {
    ...
    (gl.invert = Ks(gu)),
    (yl.invert = Ks(function (t) {
      return 2 * iu(t);
    })),
    (_l.invert = function (t, n) {
      return [-n, 2 * iu(cu(t)) - Ka];
    }),
    (Sl.prototype = Ml.prototype =
      {
        constructor: Sl,
        count: function () {
          return this.eachAfter(wl);
        },
        each: function (t) {
          var n,
            e,
        ...
        copy: function () {
          return Ml(this).eachBefore(Al);
        },
      });
  var kl = Array.prototype.slice;
  function El(t) {
    for (
      var n,
        e,
      ...
      (n = t[r]), e && zl(e, n) ? ++r : ((e = Dl((o = Cl(o, n)))), (r = 0));
    return e;
  }
  function Cl(t, n) {
    var e, r;
    ...
    for (e = 0; e < t.length; ++e)
      if (Pl(n, t[e]) && Rl(ql(t[e], n), t)) return [t[e], n];
  ...
  function Rl(t, n) {
    for (var e = 0; e < n.length; ++e) if (!zl(t, n[e])) return !1;
    return !0;
  }
  function Dl(t) {
    switch (t.length) {
  ...
  function Fl(t) {
    ...
    t: for (u = 3; u < i; ++u) {
      ...
      for (
        r.previous = n, r.next = e, n.next = e.previous = e = r, o = Bl(n);
        (r = r.next) !== e;
    ...
    for (r = El(n), u = 0; u < i; ++u) ((n = t[u]).x -= r.x), (n.y -= r.y);
    return r.r;
  }
  function Il(t) {
    return null == t ? null : Hl(t);
  }
  function Hl(t) {
  ...
  function $l(t, n) {
    return function (e) {
      if ((r = e.children)) {
        ...
        if (((o = Fl(r)), u)) for (i = 0; i < a; ++i) r[i].r -= u;
        e.r = o + u;
      }
    };
  }
  ...
  ch.prototype = Object.create(Sl.prototype);
  var sh = (1 + Math.sqrt(5)) / 2;
  function lh(t, n, e, r, i, o) {
    for (
      var a,
        u,
        c,
      ...
      y.push((a = { value: s, dice: c < f, children: _.slice(b, m) })),
        a.dice
          ? Ql(a, e, r, i, w ? (r += (f * s) / w) : o)
          : fh(a, e, r, w ? (e += (c * s) / w) : i, o),
        (w -= s),
        (b = m);
    }
    return y;
      ...
      if ((a = t._squarify) && a.ratio === n)
        for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
          for (
            ...
            u.value += c[f].value;
          u.dice
            ? Ql(u, e, r, i, (r += ((o - r) * u.value) / d))
            : fh(u, e, r, (e += ((i - e) * u.value) / d), o),
            (d -= u.value);
        }
      else (t._squarify = a = lh(n, t, e, r, i, o)), (a.ratio = n);
    }
    return (
      (e.ratio = function (n) {
        return t((n = +n) > 1 ? n : 1);
  ...
  function gh(t) {
    for (var n = t.length, e = [0, 1], r = 2, i = 2; i < n; ++i) {
      for (; r > 1 && ph(t[e[r - 2]], t[e[r - 1]], t[i]) <= 0; ) --r;
      e[r++] = i;
    }
    return e.slice(0, r);
  }
  ...
  var _h = (function t(n) {
    ...
    mh = (function t(n) {
      function e() {
        var t = bh.source(n).apply(this, arguments);
        return function () {
          return Math.exp(t());
        };
      }
  ...
  function Ch() {
    ...
    return (
      ...
      (i.range = function (t) {
        return arguments.length ? ((e = kh.call(t)), i) : e.slice();
      }),
      (i.unknown = function (t) {
        return arguments.length ? ((r = t), i) : r;
      }),
      (i.copy = function () {
        return Ch(n, e).unknown(r);
      }),
      Nh.apply(i, arguments),
      i
    );
  }
  function Ph() {
    ...
    return (
      ...
      (e.copy = function () {
        return Ph(r(), o).round(a).paddingInner(u).paddingOuter(c).align(f);
      }),
  ...
  function Uh(t, n, e) {
    var r = t[0],
      ...
      a = n[1];
    return (
      i < r ? ((r = qh(i, r)), (o = e(a, o))) : ((r = qh(r, i)), (o = e(o, a))),
      function (t) {
        return o(r(t));
      }
    );
  ...
  function Oh(t, n, e) {
    ...
    for (
      ...
      (o[u] = qh(t[u], t[u + 1])), (a[u] = e(n[u], n[u + 1]));
    return function (n) {
      var e = i(t, n, 1, r) - 1;
      return a[e](o[e](n));
    };
  ...
  function Yh() {
    ...
    function s() {
      return (
        (r = Math.min(a.length, u.length) > 2 ? Oh : Uh), (i = o = null), l
      );
    }
    function l(n) {
    ...
    return (
      ...
      (l.domain = function (t) {
        return arguments.length
          ? ((a = Sh.call(t, zh)), f === Dh || (f = Lh(a)), s())
          : a.slice();
      }),
      (l.range = function (t) {
        return arguments.length ? ((u = kh.call(t)), s()) : u.slice();
      }),
      (l.rangeRound = function (t) {
        return (u = kh.call(t)), (c = Ae), s();
      }),
      (l.clamp = function (t) {
        return arguments.length ? ((f = t ? Lh(a) : Dh), l) : f !== Dh;
      }),
  ...
  function Ih(n, e, r, i) {
    ...
    switch ((i = za(null == i ? ",f" : i)).type) {
      case "s":
        ...
        return (
          null != i.precision || isNaN((o = Ha(a, u))) || (i.precision = o),
          t.formatPrefix(i, u)
        );
      case "":
      case "e":
      ...
      case "r":
        null != i.precision ||
          isNaN((o = ja(a, Math.max(Math.abs(n), Math.abs(e))))) ||
  ...
  function Hh(t) {
    ...
    return (
      ...
      (t.tickFormat = function (t, e) {
        var r = n();
        return Ih(r[0], r[r.length - 1], null == t ? 10 : t, e);
      }),
      (t.nice = function (e) {
        null == e && (e = 10);
        var r,
  ...
  function Qh(n) {
    ...
    function u() {
      return (
        ...
        o()[0] < 0 ? ((e = Zh(e)), (r = Zh(r)), n(Vh, $h)) : n(Xh, Gh),
        i
      );
    }
    return (
  ...
  function td(t) {
    ...
    return (
      (e.constant = function (e) {
        return arguments.length ? t(Kh((n = +e)), Jh(n)) : n;
      }),
      Hh(e)
    );
  }
  ...
  function id(t) {
    var n = t(Dh, Dh),
      e = 1;
    function r() {
      return 1 === e ? t(Dh, Dh) : 0.5 === e ? t(ed, rd) : t(nd(e), nd(1 / e));
    }
    return (
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            ad.setTime(+n), ud.setTime(+r), t(ad), t(ud), Math.floor(e(ad, ud))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  var sd = fd.range,
    ...
    yd = cd(
      function (t) {
        t.setTime(
          t - t.getMilliseconds() - 1e3 * t.getSeconds() - t.getMinutes() * ld
        );
      },
      function (t, n) {
        t.setTime(+t + 36e5 * n);
    ...
    bd = cd(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * ld) / 864e5
        );
      },
      function (t) {
        return t.getDate() - 1;
  ...
  function xd(t) {
    return cd(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * ld) / hd
        );
      }
    );
  }
    ...
    function M(t, n) {
      return function (e) {
        ...
        if (("p" in o && (o.H = (o.H % 12) + 12 * o.p), "V" in o)) {
          ...
          "w" in o || (o.w = 1),
            "Z" in o
              ? ((i = (r = hp(dp(o.y))).getUTCDay()),
                (r = i > 4 || 0 === i ? $d.ceil(r) : $d(r)),
                (r = jd.offset(r, 7 * (o.V - 1))),
                (o.y = r.getUTCFullYear()),
                (o.m = r.getUTCMonth()),
                (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
              : ((i = (r = n(dp(o.y))).getDay()),
                (r = i > 4 || 0 === i ? Md.ceil(r) : Md(r)),
                (r = bd.offset(r, 7 * (o.V - 1))),
                (o.y = r.getFullYear()),
                (o.m = r.getMonth()),
                (o.d = r.getDate() + ((o.w + 6) % 7)));
        } else ("W" in o || "U" in o) && ("w" in o || (o.w = "u" in o ? o.u % 7 : "W" in o ? 1 : 0), (i = "Z" in o ? hp(dp(o.y)).getUTCDay() : n(dp(o.y)).getDay()), (o.m = 0), (o.d = "W" in o ? ((o.w + 6) % 7) + 7 * o.W - ((i + 5) % 7) : o.w + 7 * o.U - ((i + 6) % 7)));
        return "Z" in o
          ? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), hp(o))
          : n(o);
      };
    }
    function N(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (
            ((i = n.charAt(a++)),
            !(o = x[i in gp ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function wp(t) {
    return new RegExp("^(?:" + t.map(xp).join("|") + ")", "i");
  }
  function Mp(t) {
  ...
  function Bp(t, n, e) {
    var r = yp.exec(n.slice(e, e + 6));
    return r ? ((t.L = Math.floor(r[0] / 1e3)), e + r[0].length) : -1;
  }
  function Yp(t, n, e) {
    var r = _p.exec(n.slice(e, e + 1));
    return r ? e + r[0].length : -1;
  }
  function Fp(t, n, e) {
    var r = yp.exec(n.slice(e));
  ...
  function Hp(t, n) {
    return mp(t.getDate(), n, 2);
  }
  function jp(t, n) {
    return mp(t.getHours(), n, 2);
  }
  function Xp(t, n) {
    return mp(t.getHours() % 12 || 12, n, 2);
  }
  function Gp(t, n) {
    return mp(1 + bd.count(Od(t), t), n, 3);
  }
  function Vp(t, n) {
    return mp(t.getMilliseconds(), n, 3);
  }
  function $p(t, n) {
    return Vp(t, n) + "000";
  }
  function Wp(t, n) {
    return mp(t.getMonth() + 1, n, 2);
  }
  function Zp(t, n) {
    return mp(t.getMinutes(), n, 2);
  }
  function Qp(t, n) {
    return mp(t.getSeconds(), n, 2);
  }
  function Kp(t) {
    var n = t.getDay();
    return 0 === n ? 7 : n;
  ...
  function Jp(t, n) {
    return mp(wd.count(Od(t), t), n, 2);
  }
  function tv(t, n) {
    var e = t.getDay();
    return (
      (t = e >= 4 || 0 === e ? Td(t) : Td.ceil(t)),
      mp(Td.count(Od(t), t) + (4 === Od(t).getDay()), n, 2)
    );
  }
  function nv(t) {
    return t.getDay();
  ...
  function ev(t, n) {
    return mp(Md.count(Od(t), t), n, 2);
  }
  function rv(t, n) {
    return mp(t.getFullYear() % 100, n, 2);
  }
  function iv(t, n) {
    return mp(t.getFullYear() % 1e4, n, 4);
  }
  function ov(t) {
  ...
  function av(t, n) {
    return mp(t.getUTCDate(), n, 2);
  }
  function uv(t, n) {
    return mp(t.getUTCHours(), n, 2);
  }
  function cv(t, n) {
    return mp(t.getUTCHours() % 12 || 12, n, 2);
  }
  function fv(t, n) {
    return mp(1 + jd.count(fp(t), t), n, 3);
  }
  function sv(t, n) {
    return mp(t.getUTCMilliseconds(), n, 3);
  }
  function lv(t, n) {
    return sv(t, n) + "000";
  }
  function hv(t, n) {
    return mp(t.getUTCMonth() + 1, n, 2);
  }
  function dv(t, n) {
    return mp(t.getUTCMinutes(), n, 2);
  }
  function pv(t, n) {
    return mp(t.getUTCSeconds(), n, 2);
  }
  function vv(t) {
    var n = t.getUTCDay();
    return 0 === n ? 7 : n;
  ...
  function gv(t, n) {
    return mp(Vd.count(fp(t), t), n, 2);
  }
  function yv(t, n) {
    var e = t.getUTCDay();
    return (
      (t = e >= 4 || 0 === e ? Qd(t) : Qd.ceil(t)),
      mp(Qd.count(fp(t), t) + (4 === fp(t).getUTCDay()), n, 2)
    );
  }
  function _v(t) {
    return t.getUTCDay();
  ...
  function bv(t, n) {
    return mp($d.count(fp(t), t), n, 2);
  }
  function mv(t, n) {
    return mp(t.getUTCFullYear() % 100, n, 2);
  }
  function xv(t, n) {
    return mp(t.getUTCFullYear() % 1e4, n, 4);
  }
  function wv() {
    return "+0000";
  }
  ...
  function Tv(n) {
    return (
      (vp = pp(n)),
      (t.timeFormat = vp.format),
      (t.timeParse = vp.parse),
      (t.utcFormat = vp.utcFormat),
      (t.utcParse = vp.utcParse),
      vp
    );
  }
  Tv({
  ...
  var kv = +new Date("2000-01-01T00:00:00.000Z")
      ? function (t) {
          var n = new Date(t);
  ...
  function Ov(t, n, r, i, o, a, u, c, f) {
    ...
    return (
      ...
      (s.domain = function (t) {
        return arguments.length ? h(Sh.call(t, Uv)) : h().map(Lv);
      }),
      ...
      (s.nice = function (t, n) {
        var e = h();
        return (t = N(t, e[0], e[e.length - 1], n)) ? h(jh(e, t)) : s;
      }),
      (s.copy = function () {
        return Bh(s, Ov(t, n, r, i, o, a, u, c, f));
      }),
      s
    );
  }
  ...
  var Xv = jv("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
    Gv = jv("7fc97fbeaed4fdc086ffff99386cb0f0027fbf5b17666666"),
    Vv = jv("1b9e77d95f027570b3e7298a66a61ee6ab02a6761d666666"),
    $v = jv(
      "a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928"
    ),
    Wv = jv("fbb4aeb3cde3ccebc5decbe4fed9a6ffffcce5d8bdfddaecf2f2f2"),
    Zv = jv("b3e2cdfdcdaccbd5e8f4cae4e6f5c9fff2aef1e2cccccccc"),
    Qv = jv("e41a1c377eb84daf4a984ea3ff7f00ffff33a65628f781bf999999"),
    Kv = jv("66c2a5fc8d628da0cbe78ac3a6d854ffd92fe5c494b3b3b3"),
    Jv = jv(
      "8dd3c7ffffb3bebadafb807280b1d3fdb462b3de69fccde5d9d9d9bc80bdccebc5ffed6f"
    ),
    tg = jv("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");
  function ng(t) {
  ...
  var eg = new Array(3)
    ...
    Kg = new Array(3)
      .concat(
        ...
        "fff5f0fee0d2fcbba1fc9272fb6a4aef3b2ccb181da50f1566666d"
      )
      .map(jv),
    Jg = ng(Kg),
    ty = new Array(3)
      ...
      .map(jv),
    ny = ng(ty);
  var ey = Ze(re(300, 0.5, 0), re(-240, 0.5, 1)),
    ry = Ze(re(-100, 0.75, 0.35), re(80, 1.5, 0.8)),
    iy = Ze(re(260, 0.75, 0.35), re(80, 1.5, 0.8)),
    oy = re();
  var ay = bn(),
    uy = Math.PI / 3,
    cy = (2 * Math.PI) / 3;
  ...
  var vy = Math.abs,
    ...
    Ay = 2 * My;
  function Ty(t) {
    return t >= 1 ? Ny : t <= -1 ? -Ny : Math.asin(t);
  }
  function Sy(t) {
  ...
  function Uy() {
    ...
    return (
      (a.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : py(+n)), a)
          : t;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : py(+t)), a)
          : n;
      }),
      (a.defined = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : py(!!t)), a)
          : e;
      }),
      (a.curve = function (t) {
  ...
  function Oy() {
    ...
    return (
      (c.x = function (e) {
        return arguments.length
          ? ((t = "function" == typeof e ? e : py(+e)), (n = null), c)
          : t;
      }),
      (c.x0 = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : py(+n)), c)
          : t;
      }),
      (c.x1 = function (t) {
        return arguments.length
          ? ((n = null == t ? null : "function" == typeof t ? t : py(+t)), c)
          : n;
      }),
      (c.y = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : py(+t)), (r = null), c)
          : e;
      }),
      (c.y0 = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : py(+t)), c)
          : e;
      }),
      (c.y1 = function (t) {
        return arguments.length
          ? ((r = null == t ? null : "function" == typeof t ? t : py(+t)), c)
          : r;
      }),
      (c.lineX0 = c.lineY0 =
        function () {
  ...
  function jy(t) {
    ...
    return (
      ...
      delete t.y,
      (t.curve = function (t) {
        return arguments.length ? n(Hy(t)) : n()._curve;
      }),
      t
    );
  }
  function Xy() {
    return jy(Uy().curve(Fy));
  }
  function Gy() {
    var t = Oy().curve(Fy),
      n = t.curve,
  ...
  function Qy(t) {
    ...
    return (
      ...
      (a.x = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : py(+t)), a)
          : r;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : py(+t)), a)
          : i;
      }),
      (a.context = function (t) {
  ...
  var n_ = {
    ...
    a_ = Math.sin(My / 10) / Math.sin((7 * My) / 10),
    u_ = Math.sin(Ay / 10) * a_,
    c_ = -Math.cos(Ay / 10) * a_,
    f_ = {
      draw: function (t, n) {
    ...
    g_ = {
      draw: function (t, n) {
        ...
        t.moveTo(r, i),
          t.lineTo(o, a),
          t.lineTo(u, c),
          t.lineTo(-0.5 * r - d_ * i, d_ * r + -0.5 * i),
          t.lineTo(-0.5 * o - d_ * a, d_ * o + -0.5 * a),
          t.lineTo(-0.5 * u - d_ * c, d_ * u + -0.5 * c),
          t.lineTo(-0.5 * r + d_ * i, -0.5 * i - d_ * r),
          t.lineTo(-0.5 * o + d_ * a, -0.5 * a - d_ * o),
          t.lineTo(-0.5 * u + d_ * c, -0.5 * c - d_ * u),
          t.closePath();
      },
    },
    y_ = [n_, e_, o_, s_, f_, h_, g_];
  function __() {}
  function b_(t, n, e) {
  ...
  function M_(t, n) {
    (this._basis = new m_(t)), (this._beta = n);
  }
  (m_.prototype = {
    areaStart: function () {
      this._line = 0;
  ...
  var N_ = (function t(n) {
    function e(t) {
      return 1 === n ? new m_(t) : new M_(t, n);
    }
    return (
      (e.beta = function (n) {
        return t(+n);
  ...
  var D_ = (function t(n) {
    function e(t) {
      return n ? new R_(t, n) : new T_(t, 0);
    }
    return (
      (e.alpha = function (n) {
        return t(+n);
  ...
  var L_ = (function t(n) {
    function e(t) {
      return n ? new q_(t, n) : new k_(t, 0);
    }
    return (
      (e.alpha = function (n) {
        return t(+n);
  ...
  var O_ = (function t(n) {
    function e(t) {
      return n ? new U_(t, n) : new C_(t, 0);
    }
    return (
      (e.alpha = function (n) {
        return t(+n);
  ...
  function F_(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (Y_(o) + Y_(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function I_(t, n) {
  ...
  function lb(t, n, e, r) {
    ...
    return (
      ...
      e && db(i, t, n, e),
      r && db(i, n, t, r),
      Rb[t.index].halfedges.push(o),
      Rb[n.index].halfedges.push(o),
      i
    );
  }
  function hb(t, n, e) {
  ...
  (B_.prototype = {
      ...
      lineEnd: function () {
        switch (this._point) {
          case 2:
            ...
            break;
          case 3:
            H_(this, this._t0, I_(this, this._t0));
        }
        (this._line || (0 !== this._line && 1 === this._point)) &&
          this._context.closePath(),
          (this._line = 1 - this._line);
        ...
        if (((n = +n), (t = +t) !== this._x1 || n !== this._y1)) {
          switch (this._point) {
            ...
            case 1:
              ...
              break;
            case 2:
              (this._point = 3), H_(this, I_(this, (e = F_(this, t, n))), e);
              break;
            default:
              H_(this, this._t0, (e = F_(this, t, n)));
          }
          (this._x0 = this._x1),
            (this._x1 = t),
            (this._y0 = this._y1),
    ...
    ((X_.prototype = Object.create(j_.prototype)).point = function (t, n) {
      j_.prototype.point.call(this, n, t);
    }),
    (G_.prototype = {
      moveTo: function (t, n) {
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = $_(t), i = $_(n), o = 0, a = 1; a < e; ++o, ++a)
      ...
      insert: function (t, n) {
        ...
        for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
          e === (r = e.U).L
            ? (i = r.R) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.R && (cb(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                fb(this, r))
            : (i = r.L) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
            : (t === e.L && (fb(this, e), (e = (t = e).U)),
              (e.C = !1),
              (r.C = !0),
              cb(this, r)),
            (e = t.U);
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C &&
                    ((n.C = !1), (i.C = !0), cb(this, i), (n = i.R)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.R && n.R.C) ||
                    ((n.L.C = !1), (n.C = !0), fb(this, n), (n = i.R)),
                    (n.C = i.C),
                    (i.C = n.R.C = !1),
                    cb(this, i),
                    (t = this._);
                ...
                ((n = i.L).C &&
                  ((n.C = !1), (i.C = !0), fb(this, i), (n = i.L)),
                (n.L && n.L.C) || (n.R && n.R.C))
              ) {
                (n.L && n.L.C) ||
                  ((n.R.C = !1), (n.C = !0), cb(this, n), (n = i.L)),
                  (n.C = i.C),
                  (i.C = n.L.C = !1),
                  fb(this, i),
                  (t = this._);
  ...
  function Mb(t) {
    var n = t.circle;
    n &&
      (n.P || (bb = n.N), Db.remove(n), mb.push(n), ub(n), (t.circle = null));
  }
  var Nb = [];
  function Ab() {
  ...
  function Sb(t) {
    Mb(t), zb.remove(t), Nb.push(t), ub(t);
  }
  function kb(t) {
    var n = t.circle,
      e = n.x,
    ...
    for (
      var c = o;
      c.circle &&
      Math.abs(e - c.circle.x) < Lb &&
      Math.abs(r - c.circle.cy) < Lb;
    ...
    for (
      var f = a;
      f.circle &&
      Math.abs(e - f.circle.x) < Lb &&
      Math.abs(r - f.circle.cy) < Lb;
    ...
    var s,
      l = u.length;
    for (s = 1; s < l; ++s)
      (f = u[s]), (c = u[s - 1]), db(f.edge, c.site, f.site, i);
    (c = u[0]),
      ((f = u[l - 1]).edge = lb(c.site, f.site, null, i)),
      wb(c),
      wb(f);
  }
  function Eb(t) {
    for (var n, e, r, i, o = t[0], a = t[1], u = zb._; u; )
      if ((r = Cb(u, a) - o) > Lb) u = u.L;
      else {
        if (!((i = o - Pb(u, a)) > Lb)) {
          r > -Lb
            ? ((n = u.P), (e = u))
    ...
    !(function (t) {
      Rb[t.index] = { site: t, halfedges: [] };
    })(t);
    var c = Tb(t);
    if ((zb.insert(n, c), n || e)) {
      if (n === e)
        return (
          Mb(n),
          (e = Tb(n.site)),
      ...
      if (e) {
        ...
        db(e.edge, f, p, m),
          (c.edge = lb(f, t, null, m)),
          (e.edge = lb(t, p, null, m)),
          wb(n),
          wb(e);
      } else c.edge = lb(n.site, c.site);
    }
  }
  function Cb(t, n) {
    var e = t.site,
  ...
  function Yb(t, n) {
    var e,
      ...
      i,
      o = t.sort(Bb).pop();
    for (qb = [], Rb = new Array(t.length), zb = new ab(), Db = new ab(); ; )
      if (((i = bb), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
        (o[0] === e && o[1] === r) || (Eb(o), (e = o[0]), (r = o[1])),
          (o = t.pop());
      else {
        if (!i) break;
        kb(i.arc);
    ...
    if (
      ((function () {
        for (var t, n, e, r, i = 0, o = Rb.length; i < o; ++i)
          if ((t = Rb[i]) && (r = (n = t.halfedges).length)) {
            var a = new Array(r),
              u = new Array(r);
            for (e = 0; e < r; ++e) (a[e] = e), (u[e] = gb(t, qb[n[e]]));
            for (
              a.sort(function (t, n) {
                return u[n] - u[t];
              }),
      ...
      var a = +n[0][0],
        ...
        f = +n[1][1];
      !(function (t, n, e, r) {
        for (var i, o = qb.length; o--; )
          (vb((i = qb[o]), t, n, e, r) &&
            pb(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > Lb ||
              Math.abs(i[0][1] - i[1][1]) > Lb)) ||
            delete qb[o];
      })(a, u, c, f),
        (function (t, n, e, r) {
          var i,
            ...
            if ((o = Rb[i])) {
              ...
              for (u = 0, f = c.length; u < f; )
                (p = (d = _b(o, qb[c[u]]))[0]),
                  ...
                  (l = (s = yb(o, qb[c[++u % f]]))[0]),
                  (h = s[1]),
                  (Math.abs(p - l) > Lb || Math.abs(v - h) > Lb) &&
                    (c.splice(
                      u,
                      0,
                      qb.push(
                        hb(
                          a,
                          d,
                          Math.abs(p - t) < Lb && r - v > Lb
                            ? [t, Math.abs(l - t) < Lb ? h : r]
                            : Math.abs(v - r) < Lb && e - p > Lb
                            ? [Math.abs(h - r) < Lb ? l : e, r]
                            : Math.abs(p - e) < Lb && v - n > Lb
                            ? [e, Math.abs(l - e) < Lb ? h : n]
                            : Math.abs(v - n) < Lb && p - t > Lb
                            ? [Math.abs(h - n) < Lb ? l : t, n]
                            : null
                        )
                      ) - 1
                    ),
          ...
          for (i = 0; i < g; ++i)
            (o = Rb[i]) && (o.halfedges.length || delete Rb[i]);
        })(a, u, c, f);
    }
    (this.edges = qb), (this.cells = Rb), (zb = Db = qb = Rb = null);
  }
  function Fb(t) {
    return function () {
      return t;
  ...
  (Yb.prototype = {
    ...
    (Hb.prototype = {
      constructor: Hb,
      scale: function (t) {
        return 1 === t ? this : new Hb(this.k * t, this.x, this.y);
      },
      translate: function (t, n) {
        return (0 === t) & (0 === n)
          ? this
          : new Hb(this.k, this.x + this.k * t, this.y + this.k * n);
      },
      apply: function (t) {
  ...
  var jb = new Hb(1, 0, 0);
  function Xb(t) {
    for (; !t.__zoom; ) if (!(t = t.parentNode)) return jb;
    return t.__zoom;
  }
  function Gb() {
    t.event.stopImmediatePropagation();
  ...
  (Xb.prototype = Hb.prototype),
    (t.FormatSpecifier = Ra),
    ...
    (t.arc = function () {
      ...
      function c() {
        var c,
          ...
          h = i.apply(this, arguments) - Ny,
          d = o.apply(this, arguments) - Ny,
          p = vy(d - h),
          v = d > h;
        if ((u || (u = c = to()), l < s && ((f = l), (l = s), (s = f)), l > wy))
          if (p > Ay - wy)
            u.moveTo(l * yy(h), l * my(h)),
              u.arc(0, 0, l, h, d, !v),
              s > wy &&
                (u.moveTo(s * yy(d), s * my(d)), u.arc(0, 0, s, d, h, v));
          else {
            var g,
              y,
              _ = h,
              ...
              A = N > wy && (r ? +r.apply(this, arguments) : xy(s * s + l * l)),
              T = by(vy(l - s) / 2, +e.apply(this, arguments)),
              S = T,
              k = T;
            if (A > wy) {
              var E = Ty((A / s) * my(N)),
              ...
              if (
                ...
                var Y = P - q[0],
                  ...
                  j =
                    ...
                    my(
                      (function (t) {
                        return t > 1 ? 0 : t < -1 ? My : Math.acos(t);
                      })(
                        (Y * I + F * H) /
                          (xy(Y * Y + F * F) * xy(I * I + H * H))
                      ) / 2
                    ),
                  X = xy(q[0] * q[0] + q[1] * q[1]);
                (S = by(T, (s - X) / (j - 1))), (k = by(T, (l - X) / (j + 1)));
              }
            }
            M > wy
              ? k > wy
                  ...
                  k < T
                    ...
                    : (u.arc(
                      ...
                      u.arc(
                        ...
                        0,
                        l,
                        gy(g.cy + g.y11, g.cx + g.x11),
                        gy(y.cy + y.y11, y.cx + y.x11),
                        !v
                      ),
                      u.arc(
                        y.cx,
      ...
      return (
        ...
        (c.endAngle = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : py(+t)), c)
            : o;
        }),
        (c.padAngle = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : py(+t)), c)
            : a;
        }),
        (c.context = function (t) {
    ...
    (t.cluster = function () {
      ...
      function i(i) {
        ...
        i.eachAfter(function (n) {
          ...
          e
            ? ((n.x = (function (t) {
                return t.reduce(ml, 0) / t.length;
              })(e)),
              (n.y = (function (t) {
                return 1 + t.reduce(xl, 0);
              })(e)))
    ...
    (t.contourDensity = function () {
      ...
      return (
        (l.x = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : _o(+n)), l)
            : t;
        }),
        (l.y = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : _o(+t)), l)
            : n;
        }),
        (l.weight = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : _o(+t)), l)
            : e;
        }),
        (l.size = function (t) {
    ...
    (t.curveBundle = N_),
    (t.curveCardinal = S_),
    (t.curveCardinalClosed = E_),
    (t.curveCardinalOpen = P_),
    (t.curveCatmullRom = D_),
    (t.curveCatmullRomClosed = L_),
    (t.curveCatmullRomOpen = O_),
    (t.curveLinear = Dy),
    ...
    (t.drag = function () {
      ...
      function y() {
        if (o.apply(this, arguments)) {
          var n,
            ...
            u = r.length;
          for (n = 0; n < u; ++n)
            (e = m(r[n].identifier, i, Yt, this, arguments)) &&
              (Ft(), e("start"));
        }
      }
      function _() {
      ...
      function m(n, e, r, i, o) {
        ...
        if (
          kt(
            new Gt(d, "beforestart", a, n, l, p[0], p[1], 0, 0, v),
            function () {
              return (
    ...
    (t.forceCollide = function (t) {
      ...
      function o() {
        for (var t, o, u, c, f, s, l, h = n.length, d = 0; d < i; ++d)
          for (o = ga(n, ma, xa).visitAfter(a), t = 0; t < h; ++t)
            (u = n[t]),
              (s = e[u.index]),
              (l = s * s),
              (c = u.x + u.vx),
      ...
      return (
        "function" != typeof t && (t = sa(null == t ? 1 : +t)),
        ...
        (o.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : sa(+n)), u(), o)
            : t;
        }),
        o
      );
    ...
    (t.forceLink = function (t) {
      ...
      return (
        ...
        (s.strength = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : sa(+t)), h(), s)
            : u;
        }),
        (s.distance = function (t) {
          return arguments.length
            ? ((c = "function" == typeof t ? t : sa(+t)), d(), s)
            : c;
        }),
        s
      );
    ...
    (t.forceManyBody = function () {
      ...
      return (
        ...
        (c.strength = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : sa(+t)), f(), c)
            : i;
        }),
    ...
    (t.forceRadial = function (t, n, e) {
      ...
      return (
        ...
        (u.strength = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : sa(+t)), c(), u)
            : a;
        }),
        (u.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : sa(+n)), c(), u)
            : t;
        }),
        (u.x = function (t) {
    ...
    (t.forceX = function (t) {
      ...
      return (
        "function" != typeof t && (t = sa(null == t ? 0 : +t)),
        (o.initialize = function (t) {
          (n = t), a();
        }),
        (o.strength = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : sa(+t)), a(), o)
            : i;
        }),
        (o.x = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : sa(+n)), a(), o)
            : t;
        }),
        o
      );
    ...
    (t.geoAlbersUsa = function () {
      var t,
        ...
        o,
        a = Zs(),
        u = Ws().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
        c = Ws().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
        f = {
          point: function (t, n) {
            o = [t, n];
          },
        ...
        (s.translate = function (t) {
          ...
          return (
            ...
            (r = u
              ...
              .clipExtent([
                [o - 0.425 * n + Wa, s + 0.12 * n + Wa],
                [o - 0.214 * n - Wa, s + 0.234 * n - Wa],
              ])
              .stream(f)),
            (i = c
              .translate([o - 0.205 * n, s + 0.212 * n])
              .clipExtent([
                [o - 0.214 * n + Wa, s + 0.166 * n + Wa],
                [o - 0.115 * n - Wa, s + 0.234 * n - Wa],
              ])
              .stream(f)),
            l()
          );
    ...
    (t.geoArea = function (t) {
      return Pu.reset(), Nu(t, zu), 2 * Pu;
    }),
    (t.geoAzimuthalEqualArea = function () {
      return Xs(Js).scale(124.75).clipAngle(179.999);
    }),
    (t.geoAzimuthalEqualAreaRaw = Js),
    (t.geoAzimuthalEquidistant = function () {
      return Xs(tl).scale(79.4188).clipAngle(179.999);
    }),
    (t.geoAzimuthalEquidistantRaw = tl),
    (t.geoBounds = function (t) {
      var n, e, r, i, o, a, u;
      if (
        ((Vu = Gu = -(ju = Xu = 1 / 0)), (Ku = []), Nu(t, yc), (e = Ku.length))
      ) {
        for (Ku.sort(Tc), n = 1, o = [(r = Ku[0])]; n < e; ++n)
          Sc(r, (i = Ku[n])[0]) || Sc(r, i[1])
            ? (Ac(r[0], i[1]) > Ac(r[0], r[1]) && (r[1] = i[1]),
              Ac(i[0], r[1]) > Ac(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
        for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          (i = o[n]),
            (u = Ac(r[1], i[0])) > a && ((a = u), (ju = i[0]), (Gu = r[1]));
      }
      return (
        (Ku = Ju = null),
        ju === 1 / 0 || Xu === 1 / 0
    ...
    (t.geoCentroid = function (t) {
      (tc = nc = ec = rc = ic = oc = ac = uc = cc = fc = sc = 0), Nu(t, kc);
      var n = cc,
        e = fc,
        r = sc,
        i = n * n + e * e + r * r;
      return i < Za &&
        ...
        (e = ac),
        (r = uc),
        nc < Wa && ((n = ec), (e = rc), (r = ic)),
        (i = n * n + e * e + r * r) < Za)
        ? [NaN, NaN]
        : [ou(e, n) * nu, gu(r / du(i)) * nu];
    }),
    (t.geoCircle = function () {
      var t,
        ...
        o = {
          point: function (e, r) {
            t.push((e = n(e, r))), (e[0] *= nu), (e[1] *= nu);
          },
        };
      function a() {
        var a = e.apply(this, arguments),
          u = r.apply(this, arguments) * eu,
          c = i.apply(this, arguments) * eu;
        return (
          (t = []),
          (n = Ic(-a[0] * eu, -a[1] * eu, 0).invert),
          Vc(o, u, c, 1),
      ...
      return (
        (a.center = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : Bc([+t[0], +t[1]])), a)
            : e;
        }),
        (a.radius = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Bc(+t)), a)
            : r;
        }),
        (a.precision = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : Bc(+t)), a)
            : i;
        }),
        a
      );
    }),
    (t.geoClipAntimeridian = uf),
    (t.geoClipCircle = cf),
    (t.geoClipExtent = function () {
      ...
      return (e = {
        stream: function (e) {
          return t && n === e ? t : (t = lf(r, i, o, a)((n = e)));
        },
        extent: function (u) {
          return arguments.length
            ? ((r = +u[0][0]),
    ...
    (t.geoClipRectangle = lf),
    (t.geoConicConformal = function () {
      return Vs(il).scale(109.5).parallels([30, 30]);
    }),
    (t.geoConicConformalRaw = il),
    (t.geoConicEqualArea = Ws),
    (t.geoConicEqualAreaRaw = $s),
    (t.geoConicEquidistant = function () {
      return Vs(al).scale(131.154).center([0, 13.9389]);
    }),
    (t.geoConicEquidistantRaw = al),
    (t.geoContains = function (t, n) {
      return (t && Nf.hasOwnProperty(t.type) ? Nf[t.type] : Tf)(t, n);
    }),
    (t.geoDistance = Mf),
    (t.geoEqualEarth = function () {
      return Xs(hl).scale(177.158);
    }),
    (t.geoEqualEarthRaw = hl),
    (t.geoEquirectangular = function () {
      return Xs(ol).scale(152.63);
    }),
    (t.geoEquirectangularRaw = ol),
    (t.geoGnomonic = function () {
      return Xs(dl).scale(144.049).clipAngle(60);
    }),
    (t.geoGnomonicRaw = dl),
    (t.geoGraticule = Df),
    ...
    (t.geoIdentity = function () {
      ...
      return (o = {
        ...
        scale: function (t) {
          return arguments.length
            ? ((l = pl((a = +t) * f, a * s, u, c)), p())
            : a;
        },
        translate: function (t) {
          return arguments.length
            ? ((l = pl(a * f, a * s, (u = +t[0]), (c = +t[1]))), p())
            : [u, c];
        },
        reflectX: function (t) {
          return arguments.length
            ? ((l = pl(a * (f = t ? -1 : 1), a * s, u, c)), p())
            : f < 0;
        },
        reflectY: function (t) {
          return arguments.length
            ? ((l = pl(a * f, a * (s = t ? -1 : 1), u, c)), p())
            : s < 0;
        },
        ...
        g = p
          ? function (t) {
              var n = lu((t *= p)) / v,
                ...
                i = e * l + n * d,
                o = e * u + n * f;
              return [ou(i, r) * nu, ou(o, du(r * r + i * i)) * nu];
            }
          : function () {
              return [e * nu, r * nu];
            };
    ...
    (t.geoMercator = function () {
      return el(nl).scale(961 / tu);
    }),
    (t.geoMercatorRaw = nl),
    (t.geoNaturalEarth1 = function () {
      return Xs(vl).scale(175.295);
    }),
    (t.geoNaturalEarth1Raw = vl),
    (t.geoOrthographic = function () {
      return Xs(gl)
        .scale(249.5)
        .clipAngle(90 + Wa);
    }),
    (t.geoOrthographicRaw = gl),
    (t.geoPath = function (t, n) {
      ...
      return (
        (o.area = function (t) {
          return Nu(t, e(If)), If.result();
        }),
        (o.measure = function (t) {
          return Nu(t, e(ks)), ks.result();
        }),
        (o.bounds = function (t) {
          return Nu(t, e(Qf)), Qf.result();
        }),
        (o.centroid = function (t) {
          return Nu(t, e(ls)), ls.result();
        }),
        (o.projection = function (n) {
          return arguments.length
            ? ((e = null == n ? ((t = null), qf) : (t = n).stream), o)
            : t;
        }),
        (o.context = function (t) {
          return arguments.length
            ? ((r = null == t ? ((n = null), new Ps()) : new xs((n = t))),
    ...
    (t.geoProjection = Xs),
    (t.geoProjectionMutator = Gs),
    (t.geoRotation = Gc),
    (t.geoStereographic = function () {
      return Xs(yl).scale(250).clipAngle(142);
    }),
    (t.geoStereographicRaw = yl),
    (t.geoStream = Nu),
    ...
    (t.interpolateBlues = Xg),
    (t.interpolateBrBG = rg),
    (t.interpolateBuGn = xg),
    (t.interpolateBuPu = Mg),
    ...
    (t.interpolateCool = iy),
    (t.interpolateCubehelix = We),
    (t.interpolateCubehelixDefault = ey),
    ...
    (t.interpolateGnBu = Ag),
    (t.interpolateGreens = Vg),
    (t.interpolateGreys = Wg),
    (t.interpolateHcl = Ge),
    ...
    (t.interpolateMagma = ly),
    (t.interpolateNumber = be),
    (t.interpolateObject = me),
    (t.interpolateOrRd = Sg),
    (t.interpolateOranges = ny),
    (t.interpolatePRGn = og),
    (t.interpolatePiYG = ug),
    (t.interpolatePlasma = dy),
    (t.interpolatePuBu = Pg),
    (t.interpolatePuBuGn = Eg),
    (t.interpolatePuOr = fg),
    (t.interpolatePuRd = Rg),
    (t.interpolatePurples = Qg),
    ...
    (t.interpolateRdBu = lg),
    (t.interpolateRdGy = dg),
    (t.interpolateRdPu = qg),
    (t.interpolateRdYlBu = vg),
    (t.interpolateRdYlGn = yg),
    (t.interpolateReds = Jg),
    (t.interpolateRgb = de),
    ...
    (t.interpolateSinebow = function (t) {
      ...
      return (
        (t = (0.5 - t) * Math.PI),
        (ay.r = 255 * (n = Math.sin(t)) * n),
        (ay.g = 255 * (n = Math.sin(t + uy)) * n),
        (ay.b = 255 * (n = Math.sin(t + cy)) * n),
        ay + ""
      );
    }),
    (t.interpolateSpectral = bg),
    ...
    (t.interpolateViridis = sy),
    (t.interpolateWarm = ry),
    (t.interpolateYlGn = Bg),
    (t.interpolateYlGnBu = Ug),
    (t.interpolateYlOrBr = Fg),
    (t.interpolateYlOrRd = Hg),
    ...
    (t.nest = function () {
      ...
      function o(e, i, a, u) {
        ...
        for (
          var c, f, s, l = -1, h = e.length, d = r[i++], p = uo(), v = a();
          ++l < h;
    ...
    (t.pack = function () {
      ...
      function i(i) {
        return (
          ...
          (i.y = e / 2),
          t
            ? i.eachBefore(Vl(t)).eachAfter($l(r, 0.5)).eachBefore(Wl(1))
            : i
                .eachBefore(Vl(Gl))
                .eachAfter($l(jl, 1))
                .eachAfter($l(r, i.r / Math.min(n, e)))
                .eachBefore(Wl(Math.min(n, e) / (2 * i.r))),
          i
        );
      }
      return (
        (i.radius = function (n) {
          return arguments.length ? ((t = Il(n)), i) : t;
        }),
        (i.size = function (t) {
    ...
    (t.pie = function () {
      ...
      function a(a) {
        var u,
          ...
          y = Math.min(Ay, Math.max(-Ay, i.apply(this, arguments) - g)),
    ...
    (t.polygonHull = function (t) {
      ...
      for (r.sort(vh), n = 0; n < e; ++n) i[n] = [r[n][0], -r[n][1]];
      var o = gh(r),
        a = gh(i),
        u = a[0] === o[0],
    ...
    (t.radialLine = Xy),
    (t.randomBates = wh),
    (t.randomExponential = Mh),
    (t.randomIrwinHall = xh),
    (t.randomLogNormal = mh),
    (t.randomNormal = bh),
    (t.randomUniform = _h),
    (t.range = g),
    (t.rgb = bn),
    (t.ribbon = function () {
      ...
      function a() {
        ...
        if (
          ...
          o.arc(0, 0, s, l, h),
          (l === g && h === y) ||
            (o.quadraticCurveTo(0, 0, v * Fi(g), v * Ii(g)),
            o.arc(0, 0, v, g, y)),
      ...
      return (
        (a.radius = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : Wi(+t)), a)
            : e;
        }),
        (a.startAngle = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Wi(+t)), a)
            : r;
        }),
        (a.endAngle = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : Wi(+t)), a)
            : i;
        }),
        (a.source = function (n) {
    ...
    (t.scaleIdentity = function t(n) {
      ...
      return (
        ...
        (r.domain = r.range =
          function (t) {
            return arguments.length ? ((n = Sh.call(t, zh)), r) : n.slice();
          }),
        ...
        (n = arguments.length ? Sh.call(n, zh) : [0, 1]),
        Hh(r)
      );
    }),
    (t.scaleImplicit = Eh),
    ...
    (t.scaleLog = function t() {
      var n = Qh(Yh()).domain([1, 10]);
      return (
        (n.copy = function () {
          return Bh(n, t()).base(n.base());
        }),
        Nh.apply(n, arguments),
        n
      );
    ...
    (t.scaleQuantile = function t() {
      ...
      return (
        ...
        (c.range = function (t) {
          return arguments.length ? ((o = kh.call(t)), u()) : o.slice();
        }),
    ...
    (t.scaleSymlog = function t() {
      ...
      return (
        (n.copy = function () {
          return Bh(n, t()).constant(n.constant());
        }),
        Nh.apply(n, arguments)
      );
    }),
    (t.scaleThreshold = function t() {
      ...
      return (
        (a.domain = function (t) {
          return arguments.length
            ? ((e = kh.call(t)), (o = Math.min(e.length, r.length - 1)), a)
            : e.slice();
        }),
        (a.range = function (t) {
          return arguments.length
            ? ((r = kh.call(t)), (o = Math.min(e.length, r.length - 1)), a)
            : r.slice();
        }),
        ...
        Nh.apply(a, arguments)
      );
    }),
    (t.scaleTime = function () {
      return Nh.apply(
        Ov(Od, Ld, wd, bd, yd, vd, dd, fd, t.timeFormat).domain([
          new Date(2e3, 0, 1),
          new Date(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.scaleUtc = function () {
      return Nh.apply(
        Ov(fp, up, Vd, jd, Id, Yd, dd, fd, t.utcFormat).domain([
          Date.UTC(2e3, 0, 1),
          Date.UTC(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.stack = function () {
      ...
      return (
        (i.keys = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : py($y.call(n))), i)
            : t;
        }),
        (i.value = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : py(+t)), i)
            : r;
        }),
        (i.order = function (t) {
          return arguments.length
            ? ((n =
                null == t ? Q_ : "function" == typeof t ? t : py($y.call(t))),
              i)
            : n;
        }),
        (i.offset = function (t) {
          return arguments.length ? ((e = null == t ? Z_ : t), i) : e;
        }),
        i
      );
    }),
    ...
    (t.stackOffsetWiggle = function (t, n) {
      if ((i = t.length) > 0 && (r = (e = t[n[0]]).length) > 0) {
        ...
        (e[a - 1][1] += e[a - 1][0] = o), Z_(t, n);
      }
    }),
    (t.stackOrderAppearance = J_),
    (t.stackOrderAscending = nb),
    ...
    (t.stratify = function () {
      ...
      function e(e) {
        ...
        for (i = 0; i < s; ++i)
          (r = e[i]),
            ...
            null != (c = t(r, i, e)) &&
              (c += "") &&
              (h[(f = Kl + (u.id = c))] = f in h ? th : u);
        for (i = 0; i < s; ++i)
          if (((u = l[i]), null != (c = n(e[i], i, e)) && (c += ""))) {
            if (!(a = h[Kl + c])) throw new Error("missing: " + c);
            if (a === th) throw new Error("ambiguous: " + c);
      ...
      return (
        (e.id = function (n) {
          return arguments.length ? ((t = Hl(n)), e) : t;
        }),
        (e.parentId = function (t) {
          return arguments.length ? ((n = Hl(t)), e) : n;
        }),
        e
      );
    }),
    ...
    (t.symbol = function () {
      ...
      return (
        (r.type = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : py(n)), r)
            : t;
        }),
        (r.size = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : py(+t)), r)
            : n;
        }),
    ...
    (t.timeFormatLocale = pp),
    (t.timeFriday = Sd),
    (t.timeFridays = Dd),
    (t.timeHour = yd),
    (t.timeHours = _d),
    (t.timeInterval = cd),
    (t.timeMillisecond = fd),
    (t.timeMilliseconds = sd),
    (t.timeMinute = vd),
    (t.timeMinutes = gd),
    (t.timeMonday = Md),
    (t.timeMondays = Cd),
    ...
    (t.tree = function () {
      ...
      function i(i) {
        var c = (function (t) {
          for (var n, e, r, i, o, a = new ch(t, 0), u = [a]; (n = u.pop()); )
            if ((r = n._.children))
              for (
                ...
                u.push((e = n.children[i] = new ch(r[i], i))), (e.parent = n);
          return ((a.parent = new ch(null, 0)).children = [a]), a;
        })(i);
            ...
            for (
              ...
              (c = ih(c)),
                ...
                (i = u.z + l - o.z - f + t(u._, o._)) > 0 &&
                  (ah(uh(u, n, r), n, i), (f += i), (s += i)),
                (l += u.m),
                (f += o.m),
                (h += c.m),
                (s += a.m);
            u && !oh(a) && ((a.t = u), (a.m += l - s)),
              o && !ih(c) && ((c.t = o), (c.m += f - h), (r = n));
          }
          return r;
        })(n, i, n.parent.A || r[0]);
      }
    ...
    (t.treemap = function () {
      ...
      return (
        ...
        (s.tile = function (n) {
          return arguments.length ? ((t = Hl(n)), s) : t;
        }),
        ...
        (s.paddingTop = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Xl(+t)), s)
            : a;
        }),
        (s.paddingRight = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : Xl(+t)), s)
            : u;
        }),
        (s.paddingBottom = function (t) {
          return arguments.length
            ? ((c = "function" == typeof t ? t : Xl(+t)), s)
            : c;
        }),
        (s.paddingLeft = function (t) {
          return arguments.length
            ? ((f = "function" == typeof t ? t : Xl(+t)), s)
            : f;
        }),
        s
      );
    ...
    (t.treemapDice = Ql),
    (t.treemapResquarify = dh),
    (t.treemapSlice = fh),
    (t.treemapSliceDice = function (t, n, e, r, i) {
      (1 & t.depth ? fh : Ql)(t, n, e, r, i);
    }),
    (t.treemapSquarify = hh),
    (t.tsv = ia),
    (t.tsvFormat = Wo),
    (t.tsvFormatBody = Zo),
    (t.tsvFormatRows = Qo),
    ...
    (t.voronoi = function () {
      ...
      function r(r) {
        return new Yb(
          r.map(function (e, i) {
            var o = [
              Math.round(t(e, i, r) / Lb) * Lb,
              Math.round(n(e, i, r) / Lb) * Lb,
            ];
    ...
    (t.zoom = function () {
      ...
      function _(t, n, e) {
        var r = n[0] - e[0] * t.k,
          i = n[1] - e[1] * t.k;
        return r === t.x && i === t.y ? t : new Hb(t.k, r, i);
      }
      function b(t) {
          ...
          .tween("zoom", function () {
            ...
            return function (t) {
              if (1 === t) t = s;
                ...
                var n = h(t),
                  e = c / n[2];
                t = new Hb(e, u[0] - n[0] * e, u[1] - n[1] * e);
              }
              o.zoom(null, t);
            };
          });
      ...
      function S() {
        if (this.__zooming) {
          var e,
            ...
            s = c.length;
          for (Vb(), n && (n = clearTimeout(n)), u.taps = 0, e = 0; e < s; ++e)
      ...
      return (
        ...
        (w.prototype = {
          ...
          emit: function (t) {
            kt(new Ib(g, t, this.that.__zoom), h.apply, h, [
              t,
              this.that,
              this.args,
            ]);
        ...
        (g.wheelDelta = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Fb(+t)), g)
            : a;
        }),
        (g.filter = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Fb(!!t)), g)
            : r;
        }),
        (g.touchable = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : Fb(!!t)), g)
            : u;
        }),
        (g.extent = function (t) {
          return arguments.length
